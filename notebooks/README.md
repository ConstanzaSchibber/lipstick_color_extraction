...
| 10_active_learning (WIP) | `labels.csv`, checkpoints, catalog images | `active_learning_queue.csv`, `active_learning_seg_queue.csv`, `resnet18_classifier_al.pth` |
...
- Trained on 100% of the annotated data, no internal train/val split — 07 is the real held-out check
...
**07. [End-to-End Pipeline Evaluation](https://github.com/ConstanzaSchibber/lipstick_color_extraction/blob/main/notebooks/07_end_to_end_evaluation.ipynb)**
- Scores notebooks 06a and 06b's classifier and segmenters — together, as the pipeline a product image actually passes through — against `labels_val.csv`
